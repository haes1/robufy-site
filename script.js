  ...
  try{
    ...
    wrap.innerHTML =
      '<div class="rbx-box">'+
        ...
        '<h2>Приветственный бонус 1000 R$ новым пользователям</h2>'+
        '<p>Гарантированный бонус для новых пользователей на первую покупку. Это не лотерея — 1000 R$ получает каждый новый клиент.</p>'+
        ...
        '<div class="rbx-fine">Акция для новых пользователей. Бонус 1000 R$ — это скидка на первую покупку от 500 R$; деньгами не выдаётся и не обналичивается. Срок акции — до 31.12.2026. Не является лотереей или азартной игрой: бонус гарантирован каждому новому пользователю.</div>'+
